...
namespace ApiProjeKampi.WebUI.Controllers
{
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> ReservationList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7000/api/Reservations");
        ...
        public async Task<IActionResult> DeleteReservation(int id)
        {
            ...
            await client.DeleteAsync("https://localhost:7000/api/Reservations?id=" + id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7000/api/Reservations/GetReservation?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateReservation(UpdateReservationDto updateReservationDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7000/api/Reservations/", stringContent);
            return RedirectToAction("ReservationList");
        }
    }
}
