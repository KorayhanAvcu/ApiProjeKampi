...
namespace ApiProjeKampi.WebApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(x => x.Price).NotEmpty().WithMessage("Ürün fiyati boş geçilemez").LessThan(0).WithMessage("Ürün fiyatı negatif olmaz").GreaterThan(1000).WithMessage("Ürün fiyatı bu kadar yüksek olamaz, girdiğiniz değeri kontrol edin");
